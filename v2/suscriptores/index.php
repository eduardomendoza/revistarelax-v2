		...
		<div class="container">
			...
			<div id="tabs" class="tabs">
				...
				<header class="rounded">
					...
					<div id="user">
						<span>Excelente Día - Dr. Luis Contreras - Neurólogo</span> | <span>Hoy es Lunes 12 de diciembre del 2014</span> 
					</div>
				...
				<button class="menu-button" id="open-button">Open Menu</button>
					...
					<div class="menu-wrap">	
						<nav class="menu">
							<ul>
								<li><a href="#section-1" class="myButton purple1 rounded icon-profile"><span> Editorial</span></a></li>
								<li><a href="#section-2" class="myButton blue1 rounded icon-tablet"><span> Revista</span></a></li>
								<li><a href="#section-3" class="myButton green1 rounded icon-camera"><span> Entrevistas</span></a></li>
								<li><a href="#section-4" class="myButton orange1 rounded icon-user"><span> Congresos</span></a></li>
								<li><a href="#section-5" class="myButton red1 rounded icon-envelope"><span> Contacto</span></a></li>
							</ul>
						</nav>
